            ...
            <section class="content-section">
                <div class="container-fluid">
                    <div class="page-header mb-4">
                        <h1 class="my-auto">LMS Admin Users</h1>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 mb-3">
                             <form action="newLmsAdminSearch"  method="get">
                                <div class="input-group mb-0">
                                    <input type="text" class="form-control" placeholder="Search Admins" name="searchText" id="searchText" value="${param.searchText}">
                         ...
                         <c:forEach  items="${users}" var="user" varStatus="loop">  
	                        <div class="col-xs-12 col-md-4 col-xl-3 mb-3">
	                           ...
	                           <h5 class="card-title">Name: ${user.firstName} ${user.lastName}</h5>
	                                    ...
	                                    <p class="card-text">Licenses: ${user.licenses}   
<!-- 	                                     <span class="text-primary mr-4">License 1</span>, <span class="text-primary">License 2</span> -->
	                                     </p>
	                                </div>
	                            </div>
	                        </div>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Add/ Edit LMS Admin User</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                <form name="userForm"  method="post" modelAttribute="usr" action="newSavelmsadmin">
			                                    ...
			                                    <div class="col-xs-12 col-md-6">
			                                        <div class="form-group">
			                                            <label for="">Phone</label>
                                       							  <form:input path="usr.mobileNumber" name="mobileNumber" id="mobileNumber"  required="true" class="form-control" />
<!-- 			                                            <input type="text" class="form-control"> -->
			                                        </div>
			                                    </div>
			                                    <div class="col-xs-12 col-md-6">
...
<!-- 			                                            <input type="password" class="form-control"> -->
			                                    ...
			                                    <div class="col-xs-12 col-md-6">
			                                        <div class="form-group">
			                                           ...
			                                           <form:input path="usr.collegeName" name="collegeName" id="collegeName"  required="true" class="form-control" />
<!-- 			                                            <input type="text" class="form-control"> -->
			                                        </div>
			                                    </div>
			                                    <div class="col-xs-12 col-md-6">
			                                        <div class="form-group">
			                                            <label for="">Grade</label>
			                                             <form:input path="usr.grade" name="grade" id="grade"  required="true" class="form-control" />
<!-- 			                                            <input type="text" class="form-control"> -->
			                                        </div>
			                                    </div>
			                                    <div class="col-xs-12 col-md-6">
			                                        <div class="form-group">
			                                            ...
			                                            <form:input path="usr.classifier" name="classifier" id="classifier"  required="true" class="form-control" />
<!-- 			                                            <input type="text" class="form-control"> -->
			                                        </div>
			                                    </div>
			                                    <div class="col-12">
			                                        <div class="form-group">
			                                            ...
			                                            <form:select path="usr.lic" multiple="true" class="form-control" id="license">
...
<!-- 			                                            </select> -->
        ...
        <script>
        	...
        	$('#search').on('click',function(){
        		...
        		if(text.length != 0){
        		window.location="newLmsAdminSearch?searchText="+text;
        		}
        	    });
        	...
        	function openModal(){
	    	    		...
	    	    		$("#grade").val("");
	    	    		$("#classifier").val("");
	    	    		 $('#license option').attr('selected', false);
	    	    	 $("#exampleModalCenter").modal("show");
	          	};
	          	
        	function editUser(email){
        		   $.get("editLMSAdmin?email=" + email, function(data, status) {
	    	    		$("#firstName").val(data.user2.firstName);
	    	    		$("#lastName").val(data.user2.lastName);
	    	    		$("#email").val(data.user2.email);
	    				$("#email").attr("readonly", "readonly"); 
	    	    		$("#password").val(data.user2.password);
	    	    		$("#mobileNumber").val(data.user2.mobileNumber);
	    	    		$("#collegeName").val(data.user2.collegeName);
	    	    		$("#grade").val(data.user2.grade);
	    	    		$("#classifier").val(data.user2.classifier);
	    	    		 $('#license option').attr('selected', false);
	    	    		$.each(data.user2.lic, function( intIndex, objValue ){
	    	    			$('#license option[value=\'' + objValue + '\']').attr('selected', true);
// 	    	    			$('#license option[value=' + objValue + ']').attr('selected', true);
	    	    		});
	    	    	 $("#exampleModalCenter").modal("show");
	          	});
