...
.leftdivU .topmenu a{
    ...
    <body>
        ...
        <div class="maincontainer">            
            ...
            <div class="wrapper">
				...
				<a href="javascript:showFileDialogLicense();" id="uploadUsersLink">Import Users with License</a>
				
					
				<form id="fileFormUsersLicense" method="POST" enctype="multipart/form-data" >
					<input type="file" name="fileFromUserFormLicense" id="fileFromUserFormLicense" style="display:none" />
				</form>
	...
	function showFileDialogLicense(){
		$("#fileFromUserFormLicense").click();
	}
