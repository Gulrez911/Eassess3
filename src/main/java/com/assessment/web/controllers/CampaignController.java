...
public class CampaignController {
	...
	public ModelAndView showClusters(@RequestParam(name= "page", required = false) Integer pageNumber,HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	@RequestMapping(value = "/goToStep2", method = RequestMethod.GET)
	 public @ResponseBody String goToStep2(@RequestParam("campaignName") String campaignName, @RequestParam("campaignDesc") String campaignDesc,    HttpServletRequest request, HttpServletResponse response) {
	 ...
	 @RequestMapping(value = "/addCampaignStep", method = RequestMethod.GET)
	 public @ResponseBody String addCampaignStep( @RequestParam("stepName") String stepName, @RequestParam("testid") Long testid,   HttpServletRequest request, HttpServletResponse response) {
		 User user = (User) request.getSession().getAttribute("user");
		 Campaign campaign = (Campaign)request.getSession().getAttribute("campaign");
	 ...
	 @RequestMapping(value = "/addMeetingToCampaign", method = RequestMethod.GET)
	 public @ResponseBody String addMeetingToCampaign( @RequestParam("stepName") String stepName, @RequestParam("meetId") Long meetId,   HttpServletRequest request, HttpServletResponse response) {
		 User user = (User) request.getSession().getAttribute("user");
		 Campaign campaign = (Campaign)request.getSession().getAttribute("campaign");
	 ...
	 @RequestMapping(value = "/removeCampaignStep", method = RequestMethod.GET)
	 ...
	 @RequestMapping(value = "/showCampaignStepDialog", method = RequestMethod.GET)
	 public @ResponseBody String showCampaignStepDialog( @RequestParam(required=false, name="searchTest") String searchTest,  HttpServletRequest request, HttpServletResponse response) {
		 User user = (User) request.getSession().getAttribute("user");
	...
	@RequestMapping(value = "/checkForCampaignName", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/getSelectedCandidatesForCampaign", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/getSelectedReviewersForCampaign", method = RequestMethod.GET)
	...
	//reviewerMappingService
		@RequestMapping(value = "/searchAndPopulateCandidatesTable", method = RequestMethod.GET)
		 public @ResponseBody String searchAndPopulateCandidatesTable(@RequestParam(required=false, name="search") String search,  @RequestParam(required=true, name="campaignName") String campaignName, HttpServletRequest request, HttpServletResponse response) {
			 User user = (User) request.getSession().getAttribute("user");
		...
		@RequestMapping(value = "/searchAndPopulateRviewersTable", method = RequestMethod.GET)
		 public @ResponseBody String searchAndPopulateRviewersTable(@RequestParam(required=false, name="search") String search,  @RequestParam(required=true, name="campaignName") String campaignName, HttpServletRequest request, HttpServletResponse response) {
			 User user = (User) request.getSession().getAttribute("user");
			 campaignName = URLDecoder.decode(campaignName);
		...
		@RequestMapping(value = "/selectCandidateForCampaign", method = RequestMethod.GET)
		 public @ResponseBody String selectCandidateForCampaign(@RequestParam(required=true, name="cid") Long cid, @RequestParam(required=true, name="campaignName") String campaignName, HttpServletRequest request, HttpServletResponse response) {
			 User user = (User) request.getSession().getAttribute("user");
			...
			campaignCandidate.setCampaignName(URLDecoder.decode(campaignName));
		...
		@RequestMapping(value = "/selectReviewerForCampaign", method = RequestMethod.GET)
		 public @ResponseBody String selectReviewerForCampaign(@RequestParam(required=true, name="rid") Long rid, @RequestParam(required=true, name="campaignName") String campaignName, HttpServletRequest request, HttpServletResponse response) {
			 User user = (User) request.getSession().getAttribute("user");
			...
			reviewerCampaignMapping.setCampaignName(URLDecoder.decode(campaignName));
		...
		@RequestMapping(value = "/unselectCandidateForCampaign", method = RequestMethod.GET)
		 public @ResponseBody String unselectCandidateForCampaign(@RequestParam(required=true, name="cid") Long cid, @RequestParam(required=true, name="campaignName") String campaignName, HttpServletRequest request, HttpServletResponse response) {
			 User user = (User) request.getSession().getAttribute("user");
			User can = userService.findById(cid);
			campaignName = URLDecoder.decode(campaignName);
		...
		@RequestMapping(value = "/unselectReviewerForCampaign", method = RequestMethod.GET)
		 public @ResponseBody String unselectReviewerForCampaign(@RequestParam(required=true, name="rid") Long rid, @RequestParam(required=true, name="campaignName") String campaignName, HttpServletRequest request, HttpServletResponse response) {
			User user = (User) request.getSession().getAttribute("user");
			campaignName = URLDecoder.decode(campaignName);
			CampaignReviewer rev = campaignReviewerService.getById(rid);
		...
		@RequestMapping(value = "/getCampaigStepsSummary", method = RequestMethod.GET)
		...
		@RequestMapping(value = "/getSelectedCandidatesSummary", method = RequestMethod.GET)
		...
		@RequestMapping(value = "/getSelectedReviewersSummary", method = RequestMethod.GET)
			...
			Boolean dateValidate = validateDates(startDate, endDate);
				...
				List<CampaignCandidate> candidates = campaignCandidateService.getCampaignCandidatesForCampaignMeetingByCompany(user.getCompanyId(), campaign.getCampaignName());
					...
					for(CampaignCandidate candidate : candidates){
						...
						html = html.replace("{FULL_NAME}", candidate.getFirstName()==null?"NA":candidate.getFirstName() +" "+candidate.getLastName()==null?"NA":candidate.getLastName());
						...
						EmailGenericMessageThread client = new EmailGenericMessageThread(candidate.getEmail(), "Campaign Link - "+campaign.getCampaignName()+" Sent by E-ASSESS", html, propertyConfig);
			    ...
			    mav.addObject("campaigns", campaigns2);
			    	if(dateValidate){
			    		...
			    		mav.addObject("message", "Campaign - "+campaign.getCampaignName()+" has been saved. However Dates configured seem to be invalid. So we will share the link with 1 year validity from today with Candidates.");// later put it as label
			    	}
		...
		private String getCampaignLinkForTestTaker(String campaignName, String companyId, String email, String firstName, String lastName, String sdate, String edate){
			...
			url+= controllerMethod+"?campaignName="+campaignName+"&companyId="+companyId+"&email="+email+"&firstName="+firstName+"&lastName="+lastName+"&startdate="+sdate+"&enddate="+edate;
			return url;
		}
